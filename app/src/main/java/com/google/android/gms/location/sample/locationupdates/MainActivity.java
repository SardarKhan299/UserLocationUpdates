...
public class MainActivity extends AppCompatActivity {
    ...
    private void showDialogFileRename() {
        Log.d(TAG, "showDialogFileRename: ");
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        final EditText edittext = new EditText(this);
        alert.setMessage("Enter File Name to save");
    ...
    public void renameFile(String oldName,String newName){
        ...
        if(storageDir.exists()){
            File from = new File(storageDir,oldName);
            File to = new File(storageDir,newName);
            if(from.exists()) {
                Log.d(TAG, "renameFile: File Exist Rename it");
                boolean isFileRenamed = from.renameTo(to);
                Log.d(TAG, "renameFile: File Renamed "+isFileRenamed);
            }else{
                Log.d(TAG, "renameFile: File Not Exist");
            }
        }else{
            Log.d(TAG, "renameFile: Directory Not Exist...");
        }
    }
